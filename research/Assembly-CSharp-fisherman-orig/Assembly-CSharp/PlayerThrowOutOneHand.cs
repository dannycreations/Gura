...
public class PlayerThrowOutOneHand : PlayerStateBase
{
	protected override void onEnter()
	{
		...
		if (reelType != ReelTypes.Spinning)
		{
			...
			{
				this.AnimationState = base.Player.PlayAnimation("BaitThrowOneHandOut", 1f, 1f, 0f);
			}
		}
		else
		{
			this.AnimationState = base.Player.PlayAnimation("ThrowOneHandOut", 1f, 1f, 0f);
		}
