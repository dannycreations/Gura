...
namespace InControl
{
	...
	public class PlayStation3MacProfile : UnityInputDeviceProfile
	{
		public PlayStation3MacProfile()
		{
			...
			this.JoystickNames = new string[] { "Sony PLAYSTATION(R)3 Controller", "SHENGHIC 2009/0708ZXW-V1Inc. PLAYSTATION(R)3Conteroller", "SZMY-POWER CO.,LTD. GAMEPAD 3 TURBO", "Gasia Co.,Ltd PS(R) Gamepad" };
