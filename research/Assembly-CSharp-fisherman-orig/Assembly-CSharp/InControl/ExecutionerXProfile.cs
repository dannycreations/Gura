...
namespace InControl
{
	...
	public class ExecutionerXProfile : UnityInputDeviceProfile
	{
		public ExecutionerXProfile()
		{
			...
			base.IncludePlatforms = new string[] { "Windows", "OS X" };
			this.JoystickNames = new string[] { "Zeroplus PS Vibration Feedback Converter", "Zeroplus PS Vibration Feedback Converter " };
