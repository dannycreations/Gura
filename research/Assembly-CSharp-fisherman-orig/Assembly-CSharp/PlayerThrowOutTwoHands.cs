...
public class PlayerThrowOutTwoHands : PlayerStateBase
{
	protected override void onEnter()
	{
		...
		if (reelType != ReelTypes.Spinning)
		{
			...
			{
				this.AnimationState = base.Player.PlayAnimation("BaitThrow2HandsOut", 1f, 1f, 0f);
			}
		}
		else
		{
			this.AnimationState = base.Player.PlayAnimation("throwOut", 1f, 1f, 0f);
		}
