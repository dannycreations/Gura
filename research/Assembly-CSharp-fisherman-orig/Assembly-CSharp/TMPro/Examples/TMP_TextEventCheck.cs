...
namespace TMPro.Examples
{
	public class TMP_TextEventCheck : MonoBehaviour
	{
		...
		{
			Debug.Log(string.Concat(new object[] { "Character [", c, "] at Index: ", index, " has been selected." }));
		}

		private void OnSpriteSelection(char c, int index)
		{
			Debug.Log(string.Concat(new object[] { "Sprite [", c, "] at Index: ", index, " has been selected." }));
		}

		private void OnWordSelection(string word, int firstCharacterIndex, int length)
		{
			Debug.Log(string.Concat(new object[] { "Word [", word, "] with first character index of ", firstCharacterIndex, " and length of ", length, " has been selected." }));
		}

		private void OnLineSelection(string lineText, int firstCharacterIndex, int length)
		{
			Debug.Log(string.Concat(new object[] { "Line [", lineText, "] with first character index of ", firstCharacterIndex, " and length of ", length, " has been selected." }));
		}

		private void OnLinkSelection(string linkID, string linkText, int linkIndex)
		{
			Debug.Log(string.Concat(new object[] { "Link Index: ", linkIndex, " with ID [", linkID, "] and Text \"", linkText, "\" has been selected." }));
		}
