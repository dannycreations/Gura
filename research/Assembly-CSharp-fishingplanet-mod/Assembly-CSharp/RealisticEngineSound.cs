...
public class RealisticEngineSound : MonoBehaviour
{
	...
	public void PlayGearShift()
	{
		...
		{
			this.miscSounds.PlayOneShot(this.gearShiftClip, this.MasterVolume);
		}
	}
	...
	public void PlayShutdown()
	{
		...
		{
			this.miscSounds.PlayOneShot(this.shutdownClip, this.MasterVolume);
		}
	}
	...
	public void PlayStartSuccess()
	{
		...
		{
			this.miscSounds.PlayOneShot(this.startSuccessClip, this.MasterVolume);
		}
	}
	...
	public void PlayStartFail()
	{
		...
		{
			this.miscSounds.PlayOneShot(this.startFailClips[Random.Range(0, this.startFailClips.Length)], this.MasterVolume);
		}
	}
