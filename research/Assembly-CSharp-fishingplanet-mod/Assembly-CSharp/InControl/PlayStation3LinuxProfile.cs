...
namespace InControl
{
	...
	public class PlayStation3LinuxProfile : UnityInputDeviceProfile
	{
		public PlayStation3LinuxProfile()
		{
			...
			base.IncludePlatforms = new string[] { "Linux" };
			this.JoystickNames = new string[] { "Sony PLAYSTATION(R)3 Controller", "SHENGHIC 2009/0708ZXW-V1Inc. PLAYSTATION(R)3Conteroller" };
