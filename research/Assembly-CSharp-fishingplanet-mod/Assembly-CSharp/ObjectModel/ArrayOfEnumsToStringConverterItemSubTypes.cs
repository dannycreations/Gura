...
{
	public class ArrayOfEnumsToStringConverterItemSubTypes : JsonConverter
	{
		...
		public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
		{
			...
			while (reader.TokenType != 14)
			{
				...
				{
					list.Add((ItemSubTypes)Enum.Parse(typeof(ItemSubTypes), reader.Value.ToString()));
				}
				else if (reader.TokenType == 7)
				{
					list.Add((ItemSubTypes)Enum.ToObject(typeof(ItemSubTypes), (long)reader.Value));
				}
			}
			return list.ToArray();
		}
