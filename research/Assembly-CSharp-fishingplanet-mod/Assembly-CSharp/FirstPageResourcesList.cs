...
public static class FirstPageResourcesList
{
	...
	public static readonly Dictionary<int, FirstPageResource> Values = new Dictionary<int, FirstPageResource>
	{
		...
		},
		{
			...
			{
				PondId = 190,
				HeaderImage = "Textures/Local_Shops/Sliced/LaCreuse/Shop_Main_V1_Creuse_River_top",
				FooterImage = "Textures/Local_Shops/Sliced/LaCreuse/Shop_Main_V1_Creuse_River_bottom",
				MainImage = "Textures/Local_Shops/Sliced/LaCreuse/Shop_Main_V1_Creuse_River_center",
				LeftPanelSet = new FirstPageResource.RequestSet
				{
					Caption = "CreuseLeftCaption",
					Ids = new List<int>
					{
						1668, 1669, 1681, 1682, 1683, 414, 1009, 1147, 4640, 6970,
						5130, 3860, 3730, 5140, 4040, 4210, 4220, 212, 214, 3920,
						704, 5540, 706
					}
				},
				RightPanelSet = new FirstPageResource.RequestSet
