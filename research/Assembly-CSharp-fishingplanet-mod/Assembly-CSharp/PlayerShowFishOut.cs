...
public class PlayerShowFishOut : PlayerStateBase
{
	...
	protected override void onEnter()
	{
		...
		if (reelType != ReelTypes.Spinning)
		{
			...
			{
				this.showFishState = base.Player.PlayAnimation("BaitFishGripOut", 1f, 1f, 0f);
			}
		}
		else
		{
			this.showFishState = base.Player.PlayAnimation("FishGripOut", 1f, 1f, 0f);
		}
	}
