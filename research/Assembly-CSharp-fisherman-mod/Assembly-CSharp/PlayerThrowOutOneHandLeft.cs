...
public class PlayerThrowOutOneHandLeft : PlayerStateBase
{
	protected override void onEnter()
	{
		...
		if (reelType != ReelTypes.Spinning)
		{
			...
			{
				this.AnimationState = base.Player.PlayAnimation("BaitThrowLeftOut", 1f, 1f, 0f);
			}
		}
		else
		{
			this.AnimationState = base.Player.PlayAnimation("ThrowOneHandLeftOut", 1f, 1f, 0f);
		}
