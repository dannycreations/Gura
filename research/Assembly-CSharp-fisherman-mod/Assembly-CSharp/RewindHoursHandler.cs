...
public class RewindHoursHandler : MonoBehaviour, IScrollHandler, IEventSystemHandler
{
	...
	private void Awake()
	{
		this._retailRewindGo.SetActive(true);
		this._normalRewindGo.SetActive(false);
		this.RewindBackgroundPanel.GetComponent<AlphaFade>().GeometryFadePanel = this._retailRewindGo.GetComponent<GeometryFade>();
