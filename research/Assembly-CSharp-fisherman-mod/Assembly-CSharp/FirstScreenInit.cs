...
public class FirstScreenInit : MonoBehaviour
{
	...
	{
		Time.timeScale = 1f;
		this.Logo.overrideSprite = this.RetailLogoSprite;
		RectTransform component = this.Logo.GetComponent<RectTransform>();
		component.anchoredPosition = new Vector2(component.anchoredPosition.x, component.anchoredPosition.y + 1f);
