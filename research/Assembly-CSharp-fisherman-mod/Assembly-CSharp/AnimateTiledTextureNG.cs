...
public class AnimateTiledTextureNG : MonoBehaviour
{
	public void RegisterCallback(AnimateTiledTextureNG.VoidEvent cbFunction)
	{
	...
	public void UnRegisterCallback(AnimateTiledTextureNG.VoidEvent cbFunction)
	{
		if (this._enableEvents)
		{
	...
	private void Awake()
	{
		if (this._enableEvents)
		{
			this._voidEventCallbackList = new List<AnimateTiledTextureNG.VoidEvent>();
		}
	...
	private void HandleCallbacks(List<AnimateTiledTextureNG.VoidEvent> cbList)
	{
	...
	private List<AnimateTiledTextureNG.VoidEvent> _voidEventCallbackList;
