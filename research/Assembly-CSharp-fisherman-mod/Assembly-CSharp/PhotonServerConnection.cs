...
public class PhotonServerConnection : IPhotonServerConnection, IPhotonPeerListener
{
	...
	public void UnFriend(Player player, bool ignore)
	{
		...
		else
		{
			...
			if (this.OnFriendshipRemoved != null && this.profile.Friends.Count == 0)
			{
				this.OnFriendshipRemoved(player);
			}
			this.SendChatMessage(player.UserId, null, null, null, new string('E', 1), true, new DateTime?(DateTime.Now.ToUniversalTime().AddDays(99.0)));
		}
	...
	public void ManageRetailOwnership(Dictionary<string, int> ownedProducts = null)
	{
		OperationRequest operationRequest = PhotonServerConnection.CreateOperationRequest(126);
		if (ownedProducts != null)
		{
			operationRequest.Parameters[188] = CompressHelper.CompressString(JsonConvert.SerializeObject(ownedProducts, SerializationHelper.JsonSerializerSettings));
		}
		this.Peer.OpCustom(operationRequest, true, 0, true);
		OpTimer.Start(126);
	}
	...
	public void OnEvent(EventData eventData)
	{
		...
		case 136:
		{
			byte[] array = (byte[])<OnEvent>c__AnonStorey2D.eventData[192];
			Subscription[] array2 = JsonConvert.DeserializeObject<Subscription[]>(CompressHelper.DecompressString(array), SerializationHelper.JsonSerializerSettings);
			if (this.profile != null)
			{
				this.profile.DeleteSubscriptions(array2);
			}
			if (this.OnSubscriptionRemoved != null)
			{
				this.OnSubscriptionRemoved(array2);
			}
			if (array2.Any((Subscription s) => s.IsUnlock))
			{
				this.OnPondLevelInvalidated();
			}
			break;
		...
		case 137:
		{
			...
			UserCompetitionRevertMessage userCompetitionRevertMessage = JsonConvert.DeserializeObject<UserCompetitionRevertMessage>(CompressHelper.DecompressString(array3), SerializationHelper.JsonSerializerSettings);
		...
		case 139:
		{
			...
			UserCompetitionReviewMessage userCompetitionReviewMessage = JsonConvert.DeserializeObject<UserCompetitionReviewMessage>(CompressHelper.DecompressString(array4), SerializationHelper.JsonSerializerSettings);
		...
		case 140:
		{
			...
			UserCompetitionReviewMessage userCompetitionReviewMessage2 = JsonConvert.DeserializeObject<UserCompetitionReviewMessage>(CompressHelper.DecompressString(array5), SerializationHelper.JsonSerializerSettings);
		...
		case 141:
		{
			...
			UserCompetitionStartMessage userCompetitionStartMessage = JsonConvert.DeserializeObject<UserCompetitionStartMessage>(CompressHelper.DecompressString(array6), SerializationHelper.JsonSerializerSettings);
		...
		case 142:
		{
			...
			UserCompetitionCancellationMessage userCompetitionCancellationMessage = JsonConvert.DeserializeObject<UserCompetitionCancellationMessage>(CompressHelper.DecompressString(array7), SerializationHelper.JsonSerializerSettings);
		...
		case 143:
		{
			...
			UserCompetitionPromotionMessage userCompetitionPromotionMessage = JsonConvert.DeserializeObject<UserCompetitionPromotionMessage>(CompressHelper.DecompressString(array8), SerializationHelper.JsonSerializerSettings);
		...
		case 144:
		{
			...
			UserCompetitionReviewMessage userCompetitionReviewMessage3 = JsonConvert.DeserializeObject<UserCompetitionReviewMessage>(CompressHelper.DecompressString(array9), SerializationHelper.JsonSerializerSettings);
		...
		case 145:
		{
			byte[] array10 = (byte[])<OnEvent>c__AnonStorey2D.eventData[10];
			UserCompetitionTeamExchangeResponseMessage userCompetitionTeamExchangeResponseMessage = JsonConvert.DeserializeObject<UserCompetitionTeamExchangeResponseMessage>(CompressHelper.DecompressString(array10), SerializationHelper.JsonSerializerSettings);
		...
		case 146:
		{
			byte[] array11 = (byte[])<OnEvent>c__AnonStorey2D.eventData[10];
			UserCompetitionTeamExchangeMessage userCompetitionTeamExchangeMessage = JsonConvert.DeserializeObject<UserCompetitionTeamExchangeMessage>(CompressHelper.DecompressString(array11), SerializationHelper.JsonSerializerSettings);
		...
		{
			byte[] array = (byte[])<OnEvent>c__AnonStorey2D.eventData[192];
			<OnEvent>c__AnonStorey2D.json = CompressHelper.DecompressString(array);
		...
		case 153:
		{
			byte[] array12 = (byte[])<OnEvent>c__AnonStorey2D.eventData[149];
			string text5 = CompressHelper.DecompressString(array12);
		...
		case 160:
			if (this.profile != null)
			{
				byte[] array13 = (byte[])<OnEvent>c__AnonStorey2D.eventData[192];
				<OnEvent>c__AnonStorey2D.json = CompressHelper.DecompressString(array13);
		...
		case 163:
		{
			...
			if (errorCode == null)
			{
				byte[] array = (byte[])<OnEvent>c__AnonStorey2D.eventData.Parameters[192];
				<OnEvent>c__AnonStorey2D.json = CompressHelper.DecompressString(array);
		...
		case 164:
		{
			...
			UserCompetitionInvitationResponseMessage userCompetitionInvitationResponseMessage = JsonConvert.DeserializeObject<UserCompetitionInvitationResponseMessage>(CompressHelper.DecompressString(array14), SerializationHelper.JsonSerializerSettings);
		...
		case 165:
		{
			byte[] array15 = (byte[])<OnEvent>c__AnonStorey2D.eventData[10];
			UserCompetitionInvitationMessage userCompetitionInvitationMessage = JsonConvert.DeserializeObject<UserCompetitionInvitationMessage>(CompressHelper.DecompressString(array15), SerializationHelper.JsonSerializerSettings);
		...
		case 168:
		{
			<OnEvent>c__AnonStorey2D.announce = <OnEvent>c__AnonStorey2D.eventData.Parameters.ContainsKey(193) && (bool)<OnEvent>c__AnonStorey2D.eventData.Parameters[193];
			byte[] array = (byte[])<OnEvent>c__AnonStorey2D.eventData[192];
			ProfileProduct profileProduct = JsonConvert.DeserializeObject<ProfileProduct>(CompressHelper.DecompressString(array), SerializationHelper.JsonSerializerSettings);
			if (this.profile != null)
			{
				this.profile.PutProductToProfile(profileProduct);
				if (profileProduct.Items != null && profileProduct.Items.Length > 0)
		...
		case 173:
		{
			Action processProfileRestoredAfterTournament = delegate
			{
				...
				WeatherDesc[] array18 = TravelSerializationHelper.DeserializePondWeather(<OnEvent>c__AnonStorey2D.eventData.Parameters);
				if (<OnEvent>c__AnonStorey2D.$this.OnGotPondWeather != null)
				{
					<OnEvent>c__AnonStorey2D.$this.OnGotPondWeather(array18);
				}
				byte[] array19 = (byte[])<OnEvent>c__AnonStorey2D.eventData.Parameters[193];
				string text23 = CompressHelper.DecompressString(array19);
		...
		case 176:
		{
			...
			{
				array16 = (short[])<OnEvent>c__AnonStorey2D.eventData.Parameters[193];
			}
			...
			if (array16 != null)
			{
				this.OnBoatsRentFinished(array16);
			}
			break;
		}
		case 177:
		...
		case 179:
		{
			...
			{
				byte[] array17 = (byte[])<OnEvent>c__AnonStorey2D.eventData.Parameters[192];
				string text13 = CompressHelper.DecompressString(array17);
	...
	private object GetDictionaryValue(Dictionary<byte, object> dict, ProfileParameterCode key)
	{
		object obj;
		...
		throw new KeyNotFoundException(string.Concat(new object[]
		{
			"Profile parameter #",
			key,
			"(",
			Enum.GetName(typeof(ProfileParameterCode), key),
	...
	private void HandleProfileOperationResponse(OperationResponse response)
	{
		if (!response.Parameters.ContainsKey(1))
		{
			this.HandleProfileFailure("Unknown profile operation", response);
			return;
		}
		ProfileSubOperationCode profileSubOperationCode = (ProfileSubOperationCode)response[1];
		...
		if (response.ReturnCode == 0)
		{
			...
			case 220:
				...
				break;
			case 221:
				GracefulDisconnectHandler.NoGracefulDisconnectNeeded = true;
			...
			case 250:
			{
				string text4 = (string)this.GetDictionaryValue(response.Parameters, 250);
			...
			case 236:
			{
				Guid guid = new Guid((string)this.GetDictionaryValue(response.Parameters, 250));
			...
			{
				InputByteArrayWorkItem inputByteArrayWorkItem = new InputByteArrayWorkItem();
				inputByteArrayWorkItem.Data = (byte[])this.GetDictionaryValue(response.Parameters, 180);
				inputByteArrayWorkItem.ProcessAction = delegate(byte[] p)
				{
