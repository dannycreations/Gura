...
namespace InControl
{
	...
	public class PlayStation4Profile : UnityInputDeviceProfile
	{
		public PlayStation4Profile()
		{
			...
			base.Meta = string.Concat(new string[] { "DUALSHOCK", text, "4 wireless controller on PlayStation", text, "4 system" });
			base.DeviceClass = InputDeviceClass.Controller;
			base.DeviceStyle = InputDeviceStyle.PlayStation4;
			base.IncludePlatforms = new string[] { "PS4", "ORBIS" };
			this.JoystickRegex = new string[] { "controller" };
