	...
	public class InputManager
	{
		...
		internal static bool SetupInternal()
		{
			...
			if (InputManager.EnableXInput)
			{
				...
				{
					PhotonConnectionFactory.Instance.PinError(ex.Message, ex.StackTrace);
				}
			}
		...
		public static bool IsInputDeviceActivated(InputModuleManager.InputType type)
		{
			if (type == InputModuleManager.InputType.Mouse)
			{
				return InputManager.AnyKeyIsPressed || Input.GetMouseButtonDown(0) || Input.GetMouseButtonDown(1) || Input.GetMouseButtonDown(2) || (double)Mathf.Abs(Input.GetAxis("Mouse X")) > 0.01 || (double)Mathf.Abs(Input.GetAxis("Mouse Y")) > 0.01;
			}
			return type == InputModuleManager.InputType.GamePad && InputManager.IsAnyGamePadButtonPressed();
		}

		public static bool IsAnyGamePadButtonPressed()
		{
			return InputManager.ActiveDevice.AnyButtonWasPressed || InputManager.ActiveDevice.CommandWasPressed || InputManager.ActiveDevice.DPadUp.WasPressed || InputManager.ActiveDevice.DPadRight.WasPressed || InputManager.ActiveDevice.DPadDown.WasPressed || InputManager.ActiveDevice.DPadLeft.WasPressed || InputManager.ActiveDevice.DPad.WasPressed || InputManager.ActiveDevice.DPadDown.WasPressed || InputManager.ActiveDevice.LeftBumper.WasPressed || InputManager.ActiveDevice.RightBumper.WasPressed || InputManager.ActiveDevice.LeftStickX.WasPressed || InputManager.ActiveDevice.LeftStickY.WasPressed || InputManager.ActiveDevice.RightStickX.WasPressed || InputManager.ActiveDevice.RightStickY.WasPressed;
		}
