...
namespace InControl
{
	public class UnityInputDeviceProfile : UnityInputDeviceProfileBase
	{
		public UnityInputDeviceProfile()
		{
			...
			this.MaxUnityVersion = new VersionInfo(2020, 0, 0, 0);
		}
		...
		protected static InputControlSource MenuKey = new UnityKeyCodeSource(new KeyCode[] { 319 });

		protected static InputControlSource EscapeKey = new UnityKeyCodeSource(new KeyCode[] { 27 });
